...
mixin _$SignInResult<T> {
 ...
 bool get success;@JsonKey(name: 'status_code') int get statusCode; String get message;@JsonKey(name: 'new_user') bool? get newUser; T? get data; List<String>? get errors;
...
@useResult
$Res call({
 bool success,@JsonKey(name: 'status_code') int statusCode, String message,@JsonKey(name: 'new_user') bool? newUser, T? data, List<String>? errors
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success, @JsonKey(name: 'status_code')  int statusCode,  String message, @JsonKey(name: 'new_user')  bool? newUser,  T? data,  List<String>? errors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignInResult() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success, @JsonKey(name: 'status_code')  int statusCode,  String message, @JsonKey(name: 'new_user')  bool? newUser,  T? data,  List<String>? errors)  $default,) {final _that = this;
switch (_that) {
case _SignInResult():
return $default(_that.success,_that.statusCode,_that.message,_that.newUser,_that.data,_that.errors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success, @JsonKey(name: 'status_code')  int statusCode,  String message, @JsonKey(name: 'new_user')  bool? newUser,  T? data,  List<String>? errors)?  $default,) {final _that = this;
switch (_that) {
case _SignInResult() when $default != null:
return $default(_that.success,_that.statusCode,_that.message,_that.newUser,_that.data,_that.errors);case _:
  return null;
...
class _SignInResult<T> implements SignInResult<T> {
  const _SignInResult({required this.success, @JsonKey(name: 'status_code') required this.statusCode, required this.message, @JsonKey(name: 'new_user') this.newUser, this.data, final  List<String>? errors}): _errors = errors;
